...
#define	SSPxCR1		LPC_SSP1->CR1
#define	SSPxCPSR	LPC_SSP1->CPSR
#define	CS_LOW()	{LPC_GPIO->CLR[0] = (1 << 12);}	/* Set P0.6 low */
#define	CS_HIGH()	{LPC_GPIO->SET[0] = (1 << 12);}	/* Set P0.6 high */
#define RST_N	(1 << 2)
...
#define ATTACH_SSP() {\
		...
		LPC_IOCON->TMS_PIO0_12 &= ~0x7;\
		LPC_IOCON->TMS_PIO0_12 =  0x1  | (1 << 7); 	/* CS# (P0.12) */\
		LPC_GPIO->DIR[0] |= (1 << 12);\
		LPC_IOCON->TDI_PIO0_11 &= ~0x7;\
		LPC_IOCON->TDI_PIO0_11 = 0x1 | (0x2 << 3) | (1 << 7); 	/* CD# (P0.11) */\
		LPC_GPIO->DIR[0] |= (0 << 11);\
		}
#endif
